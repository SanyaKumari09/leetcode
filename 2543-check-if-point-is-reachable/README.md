<h2><a href="https://leetcode.com/problems/check-if-point-is-reachable">2543. Check if Point Is Reachable</a></h2><h3>Hard</h3><hr><p>There exists an infinitely large grid. You are currently at point <code>(1, 1)</code>, and you need to reach the point <code>(targetX, targetY)</code> using a finite number of steps.</p>
